...
function getSettings() {
    ...
    return {
        ...
        export_destination: currentSettings.export_destination || '',
...
ipcRenderer.on('image-updated', (_event, imageData) => {
...
ipcRenderer.on('render-progress', (_event, progressData) => {
    // Update progress bar
...
async function runConstructExporter() {
    ...
    try {
        ...
        const outputListener = (_event, text) => {
